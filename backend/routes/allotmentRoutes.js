...
router.post("/run", authenticateToken, async (req, res) => {
    ...
    try {
            ...
            try {
                ...
                if (existingAllotment.length > 0) {
                    ...
                    allotmentResults.push({
                        ...
                        department_id:
                            existingAllotment[0].department_id,
                        seat_number:
                            existingAllotment[0].seat_number
                    });
        ...
        return res.json({
            ...
            message:
                "Automatic seat allotment completed",
        ...
        return res.status(500).json({
            ...
            message:
                "Automatic seat allotment failed",
    ...
    try {
        ...
        if (req.user.role !== "admin") {
            ...
            return res.status(403).json({
                ...
                message:
                    "Only admin can view all allotments"
        ...
        try {
            ...
            if (
                ...
                return res.status(400).json({
                    ...
                    message:
                        "Decision must be accepted, rejected, or upward"
            ...
            if (
                ...
                return res.json({
                    ...
                    message:
                        "Allotment accepted successfully",
            ...
            if (
                ...
                return res.json({
                    ...
                    message:
                        "Allotment rejected and seat released",
